...
test("creating, performing diffs on " + modifiedJSON.length + " autogenerated JSON samples produces expected results", modifiedJSON.length + 1, function() {
    ...
    equal(1, 1, 'reached the end of ' + modifiedJSON.length + ' JSON files.');
});