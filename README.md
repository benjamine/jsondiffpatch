...
A fork of the jsondiffpatch repository.
  ...
  <body>
    ...
    <script>
      ...
      document.getElementById(
        "visual"
      ).innerHTML = jsondiffpatch.formatters.html.format(delta, left);

      // self-explained json
      document.getElementById(
        "annotated"
      ).innerHTML = jsondiffpatch.formatters.annotated.format(delta, left);
    </script>
  </body>
</html>
```
