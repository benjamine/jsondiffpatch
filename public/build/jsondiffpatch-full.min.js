...
var TEXT_DIFF=2,DEFAULT_MIN_LENGTH=60,cachedDiffPatch=null,getDiffMatchPatch=function(){if(!cachedDiffPatch){var t;if("undefined"!=typeof diff_match_patch)t="function"==typeof diff_match_patch?new diff_match_patch:new diff_match_patch.diff_match_patch;else if("function"==typeof require)try{var e=require("diff-match-patch");t=new e.diff_match_patch}catch(f){try{var i="diff_match_patch_uncompressed",e=require("../../public/external/"+i);t=new e.diff_match_patch}catch(f){t=null}}if(!t){var a=new Error("text diff_match_patch library not found");throw a.diff_match_patch_not_found=!0,a}cachedDiffPatch={diff:function(e,f){return t.patch_toText(t.patch_make(e,f))},patch:function(e,f){for(var i=t.patch_apply(t.patch_fromText(f),e),a=0;a<i[1].length;a++)if(!i[1][a]){var r=new Error("text patch failed");r.textPatchFailed=!0}return i[0]}}}return cachedDiffPatch},diffFilter=function(t){if("string"===t.leftType){var e=t.options&&t.options.textDiff&&t.options.textDiff.minLength||DEFAULT_MIN_LENGTH;if(t.left.length<e||t.right.length<e)return void t.setResult([t.left,t.right]).exit();var f=getDiffMatchPatch().diff;t.setResult([f(t.left,t.right),0,TEXT_DIFF]).exit()}};diffFilter.filterName="texts";var patchFilter=function(t){if(!t.nested&&t.delta[2]===TEXT_DIFF){var e=getDiffMatchPatch().patch;t.setResult(e(t.left,t.delta[0])).exit()}};patchFilter.filterName="texts";var textDeltaReverse=function(t){var e,f,i,a,r,c,h,n,l=null,d=/^@@ +\-(\d+),(\d+) +\+(\d+),(\d+) +@@$/;for(i=t.split("\n"),e=0,f=i.length;f>e;e++){a=i[e];var p=a.slice(0,1);"@"===p?(l=d.exec(a),c=e,h=null,n=null,i[c]="@@ -"+l[3]+","+l[4]+" +"+l[1]+","+l[2]+" @@"):"+"===p?(h=e,i[e]="-"+i[e].slice(1),"+"===i[e-1].slice(0,1)&&(r=i[e],i[e]=i[e-1],i[e-1]=r)):"-"===p&&(n=e,i[e]="+"+i[e].slice(1))}return i.join("\n")},reverseFilter=function(t){t.nested||t.delta[2]===TEXT_DIFF&&t.setResult([textDeltaReverse(t.delta[0]),0,TEXT_DIFF]).exit()};reverseFilter.filterName="texts",exports.diffFilter=diffFilter,exports.patchFilter=patchFilter,exports.reverseFilter=reverseFilter;
